...
2. **Land faithfully at the root**: no downgrades to a local patch, no unrequested defensive code or fallbacks, no drive-by refactors of neighbors, no reverting others' changes; follow the repo's layering and conventions.
