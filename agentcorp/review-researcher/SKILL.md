...
- **needs-human** — the verdict depends on context not in the repo (external systems, runtime config, product intent) or on a policy/taste call code cannot falsify. Failure to overturn is not confirmation; state precisely what is missing.
