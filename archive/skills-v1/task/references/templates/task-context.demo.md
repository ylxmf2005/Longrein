...
| --- | --- | --- |
| UD-001 | `transcript.jsonl:42` | “修好后用户能够继续完成保存操作。” |
| UD-002 | `transcript.jsonl:57` | “这次只改保存链路，不顺便重构读取。” |
| UD-003 | `transcript.jsonl:57` | “不顺便重构读取。” |
| UD-004 | `transcript.jsonl:63` | “保留现有导出文件格式。” |
...
| --- | --- | --- | --- | --- |
| SES-001 | codex | 2026-07-21T07:30:00.000Z | 2026-07-21T08:00:00.000Z | `~/.codex/sessions/.../rollout-...jsonl` |
