...
- Resolve `output_path` relative to `task_root`. When the assignment carries `workflow`, the orchestrator has already compiled that profile into your Action Context constraints (lanes, layers, rounds, item categories) — treat the field as audit metadata: follow the concrete constraints, and never scale your own care, or the honesty of evidence or status, by the profile name.
...
- `templates/architecture-proposal.demo.md`
- `templates/design-artifact.demo.md`
- `templates/dual-design-run.demo.md`
